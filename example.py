...
print 'Connecting...'
ts3 = Teamspeak.TeamSpeak() # It will connect to localhost on port 10011 (default query port)
...
ts3.registerEvent(callback=eventcallback, channel=1)
